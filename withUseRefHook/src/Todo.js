...
const Todo = () => {
    ...
    //var kuchBhi=0;
    React.useEffect(() => {
             if (!_.isEqual(previousTodo, todo)) {       // Here we are implementing the usecase of useRef hook, 
                setClicks(clicks+1);                     // if we haven't implemented this, the value of clicks and
      }                                                  // gainPoints will not go in synchronization;
    }, [todo])
    // const val=()=>{
